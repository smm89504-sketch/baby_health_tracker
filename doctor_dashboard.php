...
$full_name = htmlspecialchars($_SESSION['full_name'] ?? 'طبيب');
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .dashboard-header { background: #007bff; color: white; border-radius: 12px; padding: 25px; margin-bottom: 30px; }
        ...
        .card-body h5 { font-weight: 600; color: #007bff; }
    </style>
</head>
<body>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-10 col-md-12 main-box mt-5">
            <div class="dashboard-header text-center">
                <h1><i class="bi bi-heart-pulse-fill me-3"></i> لوحة تحكم الطبيب</h1>
                <p class="lead">مرحباً بك د. <?= $full_name ?>. هذه هي أدواتك لإدارة المرضى والرعاية الطبية.</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="medical_visits.php" class="card-link">
                        <div class="card feature-card text-center h-100">
                            <div class="card-body">
                                <i class="bi bi-calendar-check card-icon"></i>
                                <h5 class="card-title">إدارة الزيارات الطبية</h5>
                                <p class="card-text text-muted">جدولة المواعيد وتسجيل التشخيصات.</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="providers.php" class="card-link">
                        <div class="card feature-card text-center h-100">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">قائمة الزملاء والممرضين</h5>
